...
public class NotificationUtils {
     ...
     */
    public static final String NOTIFY_CHANNEL_ID_PLAY = Constants.NOTIFY_CHANNEL_ID_PLAY;
    ...
    private static void createNotificationChannel(
            Application application, String channelId, NotificationCompat.Builder builder) {
        NotificationChannel notificationChannel =
                new NotificationChannel(channelId, Constants.PLAY, NotificationManager.IMPORTANCE_DEFAULT);
