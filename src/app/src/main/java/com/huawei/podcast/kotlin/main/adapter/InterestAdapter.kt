...
class InterestAdapter(val clickListener: CategoryClickListener) : RecyclerView.Adapter<InterestAdapter.CategoryViewHolder>() {
    ...
    private var subCategoryList: List<HomePageModel> = ArrayList()
    ...
    inner class CategoryViewHolder(private val viewBinding: ItemHomeFragmentBinding) :
        RecyclerView.ViewHolder(viewBinding.root) {

        fun onBind(position: Int) {
            val row = subCategoryList[position]
    ...
    fun setList(subCategoryList: List<HomePageModel>) {
