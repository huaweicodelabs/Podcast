...
public class InterestAdapter extends RecyclerView.Adapter<InterestAdapter.ViewHolder> {
    private List<HomePageModel> interestList;
    Context context;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        HomePageModel homePageModel = interestList.get(position);
    ...
    public void setList(ArrayList<HomePageModel> interestList) {
